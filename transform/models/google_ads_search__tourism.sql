...
WITH distinct_ads AS (
        ...
        FROM 
            `real-nz-main.google_ads_tourism_search_raw.ads_Ad_5773966980`
        GROUP BY 
...
campaign_data AS (
    SELECT 
        ...
        _LATEST_DATE
    FROM 
        `real-nz-main.google_ads_tourism_search_raw.ads_Campaign_5773966980`
),
distinct_campaign AS (
    ...
    distinct_ad_group AS (
        ...
        FROM 
            `real-nz-main.google_ads_tourism_search_raw.ads_AdGroup_5773966980`
        GROUP BY 
            ad_group_id
    )
...
FROM 
    `real-nz-main.google_ads_tourism_search_raw.ads_AdBasicStats_5773966980` AS ad_stat
LEFT JOIN 
    distinct_ads AS ad 
ON 
